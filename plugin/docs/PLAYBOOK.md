...
- **CI enforces all of it.** `make check` runs the full detector set on every push and pull request — see the Integrity audit section of [AGENTS.md](https://github.com/mattbutlerengineering/ai-tooling/blob/main/AGENTS.md).
